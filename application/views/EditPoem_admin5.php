							...
							<div class="card border-0 shadow-lg">
								...
								<div class="card-body review2">
									<form style="width: 710px"  method="post" action="<?php echo base_url()?>index.php/ahooController/Editpoems">
										...
										<div class="form-group">
											<input type="radio" id="rdbtn-1" value="غزل" <?php echo $row2["form"]== "غزل" ? 'checked' : ''; ?> class="inpt-brdr-c" name="form" >
											<label for="rdbtn-1" class="lab-txt-c">غزل</label>
										</div>
										<div class="form-group">

											<input type="radio" id="rdbtn-2" value="رباعی" <?php echo $row2["form"]== "رباعی" ? 'checked' : ''; ?> class="inpt-brdr-c" name="form">
