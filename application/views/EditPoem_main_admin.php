	...
	<main>
		<div class="mt-4 mb-5">
			<div class="container">
			 ...
			 <select class="custom-select ml-3 select-custom" name="pname" id="select">
			<option selected>نام شاعر ...</option>
			 <option value="حافظ"<?php echo ($row2['pname']=='حافظ')? 'selected':''; ?>>حافظ</option> 
			 <option value="خیام" <?php echo ($row2['pname']=='خیام')? 'selected':''; ?>>خیام</option>
			 <option value="هوشنگ ابتهاج" <?php echo ($row2['pname']=='هوشنگ ابتهاج')? 'selected':''; ?>>هوشنگ ابتهاج</option>
			 <option value="مولانا" <?php echo ($row['pname']=='مولانا')? 'selected':''; ?>>مولانا</option>
			 <option value="فرخی یزدی" <?php echo ($row2['pname']=='فرخی یزدی')? 'selected':''; ?>>فرخی یزدی</option>
			 <option value="سعدی" <?php echo ($row2['pname']=='سعدی')? 'selected':''; ?>>سعدی</option>
			 <option value="سهراب سپهری" <?php echo ($row2['pname']=='سهراب سپهری')? 'selected':''; ?>>سهراب سپهری</option>
													</select>
			 <select class="custom-select ml-3 select-custom" name="book" id="select2">
			 <option selected>نام شاعر ...</option>
			 <option value="دیوان حافظ" <?php echo ($row2['book']=='دیوان حافظ')? 'selected':''; ?>>دیوان حافظ</option>
			 <option value="رباعیات خیام" <?php echo ($row2['book']=='رباعیات خیام')? 'selected':''; ?>>رباعیات خیام</option>
			 <option value="آینه در آینه"<?php echo ($row2['book']=='آینه در آینه')? 'selected':''; ?>>آینه در آینه</option>
			 <option value="سیاه مشق"<?php echo ($row2['book']=='سیاه مشق')? 'selected':''; ?>>سیاه مشق</option>
			 <option value="تاسیان"<?php echo ($row2['book']=='تاسیان')? 'selected':''; ?>>تاسیان</option>
			 <option value="دیوان شمس"<?php echo ($row2['book']=='دیوان شمس')? 'selected':''; ?>>دیوان شمس</option>
			 <option value="مثنوی معنوی"<?php echo ($row2['book']=='مثنوی معنوی')? 'selected':''; ?>>مثنوی معنوی</option>
			 <option value="فرخی یزدی"<?php echo ($row2['book']=='فرخی یزدی')? 'selected':''; ?>>فرخی یزدی</option>
			 <option value="دیوان اشعار"<?php echo ($row2['book']=='دیوان اشعار')? 'selected':''; ?>>دیوان اشعار</option>
			 <option value="بوستان"<?php echo ($row2['book']=='بوستان')? 'selected':''; ?>>بوستان</option>
			 <option value="مرگ رنگ"<?php echo ($row2['book']=='مرگ رنگ')? 'selected':''; ?>>مرگ رنگ</option>
			 <option value="حجم سبز"<?php echo ($row2['book']=='حجم سبز')? 'selected':''; ?>>حجم سبز</option>
			 <option value="شرق اندوه"<?php echo ($row2['book']=='شرق اندوه')? 'selected':''; ?>>شرق اندوه</option>
			 <option value="آوار آفتاب"<?php echo ($row2['book']=='آوار آفتاب')? 'selected':''; ?>>آوار آفتاب</option>
													</select>
			 <select class="custom-select select-custom" name="form" id="select3">
			 <option selected>نام اثر ...</option>
			 <option value="غزل"<?php echo ($row2['form']=='غزل')? 'selected':''; ?>>غزل</option>
			 <option value="رباعی"<?php echo ($row2['form']=='رباعی')? 'selected':''; ?>>رباعی</option>
			 <option value="کلاسیک و نیمایی"<?php echo ($row2['form']=='کلاسیک و نیمایی')? 'selected':''; ?>>کلاسیک و نیمایی</option>
			 <option value="مثنوی"<?php echo ($row2['form']=='مثنوی')? 'selected':''; ?>>مثنوی</option>
													</select>
												</div>
											</div>
										</div>
