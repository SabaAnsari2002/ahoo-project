							...
							<div class="card border-0 shadow-lg">
								...
								<div class="card-body review2">
									<form style="width: 710px"  method="post" action="<?php echo base_url()?>index.php/ahooController/Editpoems">
										...
										<div class="form-group">
											<input type="radio" id="rdbtn-1" value="سیاه مشق" <?php echo $row2["book"]== "سیاه مشق" ? 'checked' : ''; ?> class="inpt-brdr-c" name="book" >
											<label for="rdbtn-1" class="lab-txt-c">سیاه مشق</label>
										</div>
										<div class="form-group">
											<input type="radio" id="rdbtn-2" value="آینه در آینه" <?php echo $row2["book"]== "آینه در آینه" ? 'checked' : ''; ?> class="inpt-brdr-c" name="book">
											<label for="rdbtn-2" class="lab-txt-c">آینه در آینه</label>
										</div>
										<div class="form-group">
											<input type="radio" id="rdbtn-2" value="تاسیان" <?php echo $row2["book"]== "تاسیان" ? 'checked' : ''; ?> class="inpt-brdr-c" name="book">
											<label for="rdbtn-2" class="lab-txt-c">تاسیان</label>
										</div>
