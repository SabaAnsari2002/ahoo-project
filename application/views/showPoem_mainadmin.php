            ...
            foreach (json_decode($data2, true) as $row):   
			  ...
			  $poemhtml = html_entity_decode($first20);
				...
				?>
					  ...
					  <a href="<?php echo base_url('index.php/ahooController/showPoemValue/'.$row['id'])?>" class="text-dark">
						  <div class="card border-0 shadow mb-3">
								...
								<div class="mt-3 mt-lg-0 mr-lg-3 flex-fill">
									<p class="d-block mb-2 text-dark">
										<a href="<?php echo base_url('index.php/ahooController/showPoemValue/'.$row['id'])?>" class="text-dark" style="font-size: 20px;"><?php echo $row['name']; ?> </a>
									</p>
									...
									<div class="d-flex justify-content-between align-items-center mt-2">
										<a class="text-info-custom" href="#">
											...
											</svg>											<?php echo $row['book']; ?>
										</a>
										<a class="text-info-custom" href="<?php echo base_url('index.php/ahooController/deletePoem/'.$row['id'])?>">
											حذف
