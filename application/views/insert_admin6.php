							...
							<div class="card border-0 shadow-lg">
								...
								<div class="card-body review2">
									<form style="width: 710px"  method="post" action="<?php echo base_url() ?>index.php/ahooController/insertPoem">
										...
										<div class="form-group">
											<input type="radio" id="rdbtn-1" value="بوستان" class="inpt-brdr-c" name="book">
											<label for="rdbtn-1" class="lab-txt-c">بوستان </label>
										</div>
										<div class="form-group">

											<input type="radio" id="rdbtn-2" value="دیوان اشعار" class="inpt-brdr-c" name="book">
