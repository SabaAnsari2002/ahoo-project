								...
								<div class="card-body review2">
									<form style="width: 710px"  method="post" action="<?php echo base_url() ?>index.php/ahooController/insertPoem">
										<div class="form-group">
											...
											<input class="form-control" type="text" name="name" placeholder="عنوان شعر را وارد کنید ...">
										...
										<div class="form-group mb-5">
											...
											<div class="div-brdr">
												<textarea id="editor" name="poem" class="form-control" style="text-align: right" cols="30" rows="7" placeholder="متن شعر را وارد کنید ..."></textarea>
											</div>
										</div>
										<font color=red><?php echo form_error('poem');?></font>
										<div class="form-group">
											<input type="radio" id="rdbtn-1" value="آینه در آینه" class="inpt-brdr-c" name="book">
											<label for="rdbtn-1" class="lab-txt-c">آینه در آینه </label>
										</div>
										<div class="form-group">
											<input type="radio" id="rdbtn-2" value="سیاه مشق" class="inpt-brdr-c" name="book">
											<label for="rdbtn-2" class="lab-txt-c">سیاه مشق</label>
										</div>
										<div class="form-group">
											<input type="radio" id="rdbtn-3" value="تاسیان" class="inpt-brdr-c" name="book">
											<label for="rdbtn-3" class="lab-txt-c">تاسیان</label>
										</div>
			                            <font color=red><?php echo form_error('book');?></font>
                                      <input class="btn signup-btn py-2" style="width: 710px" type="submit" name="submit" id="submit" value="درج شعر ">	
										</div>
